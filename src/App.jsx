...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-[#090505] text-white font-sans overflow-hidden selection:bg-[#ff2a44] selection:text-white">
      ...
      <div className="w-64 bg-[#110809] border-r border-[#2b1416] flex flex-col justify-between z-20 relative">
          ...
          <nav className="px-4 space-y-2 mt-4">
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                ...
                ? 'bg-gradient-to-r from-[#2b1416] to-transparent text-[#ff2a44] border-l-2 border-[#ff2a44]' 
                : 'text-[#a38c8e] hover:bg-[#170b0c] hover:text-white'
              }`}
            >
        ...
        {/* Pro Banner & Profile */}
        <div className="p-4">
          <div className="bg-gradient-to-br from-[#ff2a44] to-[#801522] rounded-2xl p-5 mb-4 shadow-[0_0_20px_rgba(255,42,68,0.2)]">
            <h4 className="font-bold mb-1">Akaun Pro</h4>
            <p className="text-xs text-white/80 mb-3">Buka kunci analitik terperinci.</p>
            <button className="w-full bg-white text-[#ff2a44] text-xs font-bold py-2 rounded-lg hover:bg-gray-100 transition-colors">Naik Taraf</button>
          </div>
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-20 border-b border-[#2b1416] flex items-center justify-between px-8 bg-[#090505]/80 backdrop-blur-md sticky top-0 z-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              <div className="w-9 h-9 rounded-full bg-[#2b1416] border border-[#ff2a44] flex items-center justify-center text-sm font-bold group-hover:bg-[#ff2a44] group-hover:text-white transition-colors">
                AZ
              </div>
        ...
        <main className="flex-1 overflow-y-auto p-8 scrollbar-hide">
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={monthlyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    />
                    <Tooltip 
                      contentStyle={{ backgroundColor: '#170b0c', borderColor: '#ff2a44', borderRadius: '8px', color: '#fff' }}
                    ...
                    <Area 
                      ...
                      activeDot={{ r: 6, fill: '#ff2a44', stroke: '#090505', strokeWidth: 2 }}
                    />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
                ...
                <div className="h-[200px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Tooltip 
                        contentStyle={{ backgroundColor: '#090505', borderColor: '#2b1416', borderRadius: '8px' }}
                        itemStyle={{ color: '#fff' }}
                      />
                    </PieChart>
                  </ResponsiveContainer>
          ...
          {/* Bottom Row - Data Table & Risk/Reward */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            
            {/* Recent Trades Data Table */}
            <div className="lg:col-span-2 bg-[#170b0c] border border-[#2b1416] rounded-2xl p-6">
              <div className="flex justify-between items-center mb-6">
                  ...
                  <tbody className="text-sm">
                    <tr className="border-b border-[#2b1416]/50 hover:bg-[#2b1416]/40 transition-colors cursor-pointer group">
                      ...
                      <td className="py-4 text-right pr-2">
                        <span className="bg-[#4a2528]/40 text-[#ff2a44] border border-[#ff2a44]/30 px-3 py-1 rounded-full text-xs font-bold">FLOATING</span>
                      </td>
                    </tr>
                    <tr className="border-b border-[#2b1416]/50 hover:bg-[#2b1416]/40 transition-colors cursor-pointer group">
                      ...
                      <td className="py-4 text-right pr-2">
                        <span className="bg-emerald-900/30 text-emerald-400 border border-emerald-500/30 px-3 py-1 rounded-full text-xs font-bold">WIN</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-[#2b1416]/40 transition-colors cursor-pointer group">
                      <td className="py-4 pl-2 font-semibold group-hover:text-[#ff2a44] transition-colors">DNEX (4456)</td>
                      <td className="py-4 text-[#a38c8e]">Reversal</td>
                      <td className="py-4">RM 0.355</td>
                      <td className="py-4">RM 1,065.00</td>
                      <td className="py-4 text-right pr-2">
                        <span className="bg-gray-800/50 text-gray-400 border border-gray-600/50 px-3 py-1 rounded-full text-xs font-bold">BREAKEVEN</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="bg-[#170b0c] border border-[#2b1416] rounded-2xl p-6 flex flex-col justify-between hover:border-[#ff2a44]/50 transition-colors duration-300">
              <div>
                <div className="flex justify-between items-center mb-6">
                  ...
                  <div className="p-2 bg-[#2b1416] rounded-lg text-white">
                    <Target size={16} />
                  </div>
                </div>
                
                <p className="text-[#a38c8e] text-xs mb-6 leading-relaxed">
                  Purata kemenangan berbanding purata kerugian anda. Penunjuk kesihatan jangka panjang portfolio.
                </p>

                <div className="flex justify-between items-end mb-2">
                  <div>
                    <p className="text-[#a38c8e] text-xs mb-1">Purata Untung (Avg Win)</p>
                  ...
                  <div className="text-right">
                    <p className="text-[#a38c8e] text-xs mb-1">Purata Rugi (Avg Loss)</p>
                    <div className="flex items-center text-[#ff2a44] font-bold text-xl justify-end">
              ...
              <div className="mt-6">
                ...
                <p className="text-[10px] text-[#a38c8e] mt-3 text-center">
                  Anda membuat RM2.33 bagi setiap RM1 yang dirisikokan. <span className="text-emerald-400 font-semibold">Cemerlang!</span>
                </p>
              </div>
            </div>
